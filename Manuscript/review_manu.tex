...
For example, increase of order parameters as a function of cholesterol concetration \cite{??} and with 
hydration are reproduced in simulations \cite{??}. Further, the decrease due to the addition of
double bonds is also reproduced \cite{??}. 

On the other hand, the quantitative comparison of order parameter responses to varying conditions
have not been very popular. Recent comparison between widely used model (Berger lipids \cite{??} and Höltje cholesterol model \cite{??}
...
with 34\% and higher cholesterol concentration the simulation model cannot be considered to agree with experiments.
The orientation of cholesterol itself was in better agreement with experiments, except the acyl chain. 

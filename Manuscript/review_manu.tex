...
that slowest rotational correlation function (for g$_1$ segment) in the Berger model~\cite{??} reached a
a plateau ($S_\mathrm{CH}^2$) after 200~ns~\cite{ferreira15}. The comparison of rotational dynamics
of this and other segments to the experiments reveled that the rotational relaxation was, however, 
too slow in these simulations, for more details see Section~\ref{??} and~\cite{ferreira13}.

, however, even the slowest rotational correlation function of a C--H bond  (g$_1$) reaches

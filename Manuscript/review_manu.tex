...
extensive experimental data for POPC/cholesterol as Berge/H{\"o}ltje model~\cite{ferreira13} and the agreement is significantly better~\cite{madej15}. 
...
generally reproduced by different simulation models~\cite{hyvonen97,hyvonen97b,hyvonen05,ollila07a,dickson12,klauda10,ferreira13,jambeck13,lee14,dickson14}. 
Very good agreement for oleyl chain in POPC bilayer with one {\it cis} double bond is demonstrated in Fig.~\ref{allOPs} taken from Ferrereira et al.~\cite{ferreira13}.
Also the effect of multiple double bonds (polyunsaturation)~\cite{hyvonen97,hyvonen97b,hyvonen05,ollila07a,??} and
difference between {\it cis} and {\it trans} double bonds can be reproduced in MD simulations \cite{kulig15b}.

...
but those cannot be used alone to resolve the structure. The same applies practically to all
experimental parameter used in biomolecular structure determination. 

Molecular dynamics simulations is very popular techique to study the
